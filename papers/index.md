...
1. Alberto Leporati, Luca Manzoni, Giancarlo Mauri, Antonio E. Porreca and Claudio Zandron. [“Simulating elementary active membranes, with an application to the P conjecture”](https://doi.org/10.1007/978-3-319-14370-5_18). In: Membrane Computing, 15th International Conference, CMC 2014. Edited by Marian Gheorghe, Grzegorz Rozenberg, Petr Sosík and Claudio Zandron. Volume 8961. Lecture Notes in Computer Science. Springer, 2014, pages 284–299. [[preprint](simulating-elementary-active-membranes-with-application-to-p-conjecture.pdf)]
